...
def show_score(user_card, dealer_card):
    print(f'Your score {sum(user_card)}')
    print(f'Dealer score {sum(dealer_card)}')
...
while(input('do you want to play? y or n:\n') == 'y'):
    ...
    print(f'Your cards equal = {sum(user_card)}')
    print(f'Dealer card equal = {dealer_card[0]}')
    your_choice = input('Do you want another card? y or n:\n')
    if your_choice == 'y':
    ...
    if sum(user_card) > 21:
        ...
        print('Draw')
    show_score(user_card, dealer_card)
